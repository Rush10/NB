...
import ujian.ujiankelima.cucumber.scenariotest.ShopDemoqaLoginOutline;
...
public class OutlineHooks {
	...
	public static ExtentReports reports = new ExtentReports("target/shop-demoqa/extentreport/shop-demoqa-login-outline.html");
	private static ShopDemoqaLoginOutline[] tests = ShopDemoqaLoginOutline.values();
